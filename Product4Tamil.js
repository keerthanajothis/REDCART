...
const products = [
    { name: 'ஆப்பிள்', price: '1 கிலோ = 150', image: 'https://www.shutterstock.com/image-photo/red-apple-isolated-on-white-600nw-1727544364.jpg' },
    { name: 'வாழை', price: '10 பொரி = 50 ', image: 'https://media.istockphoto.com/id/173242750/photo/banana-bunch.jpg?s=612x612&w=0&k=20&c=MAc8AXVz5KxwWeEmh75WwH6j_HouRczBFAhulLAtRUU=', couponRequired: true },
    { name: 'ஆரஞ்சு', price: '1 கிலோ = 90', image: 'https://thumbs.dreamstime.com/b/sliced-orange-fruit-leaves-isolated-white-23331258.jpg' },
    { name: 'திராட்சை', price: '1 கிலோ = 100', image: 'https://www.shutterstock.com/image-photo/green-grape-leaves-isolated-on-260nw-533487490.jpg' },
    { name: 'தர்பூசணி', price: '1 கிலோ = 80', image: 'https://5.imimg.com/data5/SELLER/Default/2022/12/DM/EC/KE/49293026/fresh-watermelon-fruit-500x500.webp', couponRequired: true },
    { name: 'மாதுளை', price: '1 கிலோ = 250', image: 'https://m.media-amazon.com/images/I/611a1wD9ZGL.AC_UF1000,1000_QL80.jpg' },
    { name: 'மாம்பழம்', price: '1 கிலோ = 60', image: 'https://img.freepik.com/premium-photo/ripe-mango-with-green-leaf-isolated-white_252965-183.jpg', couponRequired: true },
    { name: 'சீதாப்பழம்', price: '1 கிலோ = 110', image: 'https://cdn.britannica.com/95/126995-050-101B8B8D/Sweetsop.jpg' },
    { name: 'சப்போட்டா', price: '1 கிலோ = 63', image: 'https://3.imimg.com/data3/WT/OF/MY-4367006/fresh-sapota-500x500.jpg' },
    { name: 'பப்பாளி', price: '1 முட்டை = 20', image: 'https://5.imimg.com/data5/ANDROID/Default/2022/6/TK/YZ/OA/145012231/prod-20220629-1548203238180800748031667-jpg-500x500.jpg', couponRequired: true },
    { name: 'கொய்யா', price: '1 கிலோ = 100', image: 'https://thumbs.dreamstime.com/b/isolated-green-guava-pink-flesh-one-whole-fruit-half-white-background-clipping-path-173876537.jpg' },
    { name: 'முஸ்க்மேலன்', price: '1 கிலோ = 80', image: 'https://blog-images-1.pharmeasy.in/blog/production/wp-content/uploads/2021/05/18150019/shutterstock_1376235665-1.jpg' }
];
...
function Accs() {
    ...
    return (
        <div className="page">
            <h2 style={{ textAlign: 'center', marginTop: '80px', color: 'white' }}>பழங்கள்</h2>
            ...
            <div className="page">
                ...
                <div>
                    ...
                    <Link to="/Product5" style={{ color: 'white', marginRight: '1000px' }}>அடுத்து</Link>
                    <Link to="/Product3" style={{ color: 'white', marginRight: '2000px' }}>முந்தைய</Link>
                </div>
            </div>
        </div>
    );
