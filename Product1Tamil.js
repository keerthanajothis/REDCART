...
const products = [
    { name: 'சாலவை பைக்ஸ்', price: '999', image: 'https://www.shutterstock.com/image-photo/luggage-consisting-large-suitcases-rucksacks-260nw-129213182.jpg', couponRequired: true },
    { name: 'பள்ளி பைக்ஸ்', price: '574', image: 'https://5.imimg.com/data5/SELLER/Default/2020/9/PN/DS/CG/113370877/55205-5-school-bag-free-clipart-hd.png' },
    { name: 'தங்க ஆபரணம்', price: '50000', image: 'https://t3.ftcdn.net/jpg/02/34/21/58/240_F_234215884_pAF9PoUM5xEAsqW8g2oXsFUPRnkuOA14.jpg', couponRequired: true },
    { name: 'கலையான வைரங்கள்', price: '60000', image: 'https://t4.ftcdn.net/jpg/06/35/97/01/240_F_635970157_dXvdme8bVtVW00VHw7JJVfreCF3HXqlU.jpg' },
    { name: 'ஃபேஷன் பங்கிள்கள்', price: '800', image: 'https://t3.ftcdn.net/jpg/05/25/54/06/240_F_525540629_QxKds12GbTjsbqv3WeMQTstCvpvgy6MC.jpg' },
    { name: 'ஸ்மார்ட் கட்டிடங்கள்', price: '3500', image: 'https://t4.ftcdn.net/jpg/02/44/17/39/240_F_244173933_QPbn77c2Tjy5A4XoOJWqxysJibBpDy3T.jpg', couponRequired: true },
    { name: 'பணவைக்கள்', price: '450', image: 'https://t4.ftcdn.net/jpg/01/39/32/25/240_F_139322524_jFW4sl5d0NBiMHwSQ0vrrrQyGvRvvFzV.jpg' },
    { name: 'ஒழுக்கம்', price: '699', image: 'https://t3.ftcdn.net/jpg/06/18/51/94/240_F_618519434_Ese9nHq1HjSTqMJCF6Xgdd8ahel0UISh.jpg', couponRequired: true },
    { name: 'பயணக் குணம்', price: '301', image: 'https://t4.ftcdn.net/jpg/04/42/89/09/240_F_442890972_a4yppIGxZUgmL67RJyMaKZEYWpYGtZ2V.jpg' },
    { name: 'சமையல் எந்திரம்', price: '1348', image: 'https://t4.ftcdn.net/jpg/05/32/10/29/240_F_532102968_dRuciqo2ApI2aG7rNwz02tChizGW09h7.jpg', couponRequired: true },
    { name: 'பயணக் கிட்ஸ்', price: '500', image: 'https://t3.ftcdn.net/jpg/04/11/59/40/240_F_411594000_w5BdtWVZ7z4pxGBg5sScjnJc5x2ApK7b.jpg' },
    { name: 'தோல் கைவினைகள்', price: '2000', image: 'https://t4.ftcdn.net/jpg/06/05/39/51/240_F_605395171_sW5hkfnffnL6Z6ZpIC0OJZTjslUeRgiQ.jpg', couponRequired: true }
];
...
function Accs() {
    ...
    const handleApplyCoupon = (product) => {
        ...
        if (couponCode === 'டிஸ்கவுண்ட்10') {
            const price = product.price;
            const discountedPrice = price - (price * 0.1); // டிஸ்கவுண்ட்10 அளவு 10% கட்டணம் பெறும்
            setCouponCodes({ ...couponCodes, [product.name]: discountedPrice });
            setDiscountedProducts([...discountedProducts, product.name]);
            alert('சரிபார்க்கப்பட்ட மொத்த கட்டணம்!');
        } else {
            alert('தவறான குறியீடு!');
        }
    };
    ...
    return (
        <div className="page">
            <h2 style={{ textAlign: 'center', marginTop: '80px', color: 'white' }}>பொருட்கள்</h2>
                                    ...
                                    {product.couponRequired && (
                                        <div>
                                            ...
                                            {couponCodes[product.name] !== undefined && (
                                                <div>
                                                    <input type="text" placeholder="குபோன் குறியீடு உள்ளிடவும்" value={couponCodes[product.name]} onChange={(e) => handleChange(e, product)} style={{ fontSize: '14px', padding: '5px', margin: '5px', borderRadius: '4px', border: '1px solid #ccc' }} />
            ...
            <div className="page">
                <h2 style={{ textAlign: 'center', marginTop: '20px', color: 'white' }}>வண்டிகள்</h2>
                ...
                <div>
                    <h3 style={{ textAlign: 'center', color: 'white' }}>மொத்த கட்டணம்: ₹{getTotalPrice()}</h3>
                    <Link to="/Product2" style={{color:'white'}}>அடுத்தது</Link>
                </div>
            </div>
        </div>
    );
