...
const products = [
    { name: 'Long Party Gown', price: 3500, image: 'https://images.meesho.com/images/products/259341621/agdu1_512.webp' },
        { name: 'Fancy Salwar', price: 1500, image: 'https://5.imimg.com/data5/SELLER/Default/2023/7/324642562/EW/VM/GZ/25660046/ladies-fancy-salwar-suits.jpg', couponRequired: true },
        {name: 'Boys Dhoti',price:599,image:'https://5.imimg.com/data5/SELLER/Default/2021/2/MM/AT/LG/89593293/designer-dupion-silk-festive-wear-kurta-with-dhoti-mens-wear-catalog-collection-500x500.jpg'},
        { name: 'Lehenga', price: 2000, image: 'https://i.etsystatic.com/17457268/r/il/1a9d30/3085484191/il_570xN.3085484191_4anj.jpg' , couponRequired: true},
        { name: 'Ethnic Wear', price: 1000, image: 'https://5.imimg.com/data5/PZ/WT/LJ/SELLER-7071255/kids-sleeveless-party-wear-gown-500x500.JPG', couponRequired: true },
        { name: 'Sarees', price: 799, image: 'https://e0.pxfuel.com/wallpapers/625/53/desktop-wallpaper-beautiful-hot-indian-models-in-saree-high-resolution-sari.jpg' },
        { name: 'cocktail Attire', price: 2999, image: 'https://www.beyoung.in/blog/wp-content/uploads/2018/11/Neck-Wear-For-Cocktail-Party-Dress-for-Men-853x1024.jpg' },
        { name: 'Lehenga Choli', price: 2500, image: 'https://anayadesignerstudio.com/wp-content/uploads/2023/01/Latest-Modern-Jacket-Lehenga-Choli-For-Girls-2023.jpg' },
        { name: 'Kids Modern Dresses', price: 999, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfLxNgCHtdinWHv8mMZGl9CLhmEKDI5nDXmA&usqp=CAU' },
        { name: 'Western Dress', price: 599, image: 'https://rukminim1.flixcart.com/image/850/850/xif0q/shopsy-dress/b/j/3/xxl-g-8-101-181-lookavira-original-imaghyr4w8nqkzpn.jpeg?q=20' , couponRequired: true},
        { name: 'Boys Jeans', price: 250, image: 'https://5.imimg.com/data5/MI/JO/MY-33510293/trendy-boys-jeans.jpg', couponRequired: true },
        { name: 'Hoddie', price: 300, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSr5QsqOWTiflMpKPe5eiweS4F4TLGieoCJyA&usqp=CAU' }
...
function Accs() {
    ...
    return (
        <div className="page">
            <h2 style={{ textAlign: 'center', marginTop: '80px', color: 'white' }}>DRESSES</h2>
            ...
            <div className="page">
                ...
                <div>
                    ...
                    <Link to="/Product4"style={{color:'white',marginRight:'1000px'}}>NEXT</Link>
                    <Link to="/Product2"style={{color:'white',marginRight:'2000px'}}>PREV</Link>
